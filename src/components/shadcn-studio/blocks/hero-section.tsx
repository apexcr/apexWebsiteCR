...
const HeroSection = ({ products }: { products: ProductItem[] }) => {
          ...
          <div className="flex w-full flex-col justify-center gap-5 max-lg:items-center lg:col-span-3 lg:h-95.5">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button size="lg" asChild>
                <Link href="/order">Ver todos los productos</Link>
              </Button>
            </div>
          </div>
          ...
          >
            <CarouselContent>
              {products.map((item) => (
                ...
                >
                  <div className="border-background bg-muted text-muted-foreground flex size-10 items-center justify-center rounded-full border-4 drop-shadow-lg">
                  ...
                  />
                  <p className="text-card-foreground">lorem...</p>
                </CarouselItem>
              ))}
            </CarouselContent>
          </Carousel>
